  ...
  <script type="text/javascript">
    $(document).ready(function () {
      ...
      modalElement.addEventListener('shown.bs.modal', function (event) {
        ...
        const posisi = BpsDashboardKuansingMapbox.toLngLat(link.data('lat'), link.data('lng'));
        const zoom = link.data('zoom') || 10;

        // Menampilkan BaseLayers Peta
        var mapboxKey = <?= json_encode(bps_dashboard_kuansing_mapbox_key()) ?>;
        ...
        pembangunanMap = BpsDashboardKuansingMapbox.createMap({
